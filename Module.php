...
use Publications\Listener\PublicationsSliderDeletedListener;
use Publications\Listener\PublicationsFlashMessengerListener;
...
class Module
{
    public function onBootstrap(MvcEvent $e)
    {
        ...
        if ($melisRoute)
        {
            ...
            //$eventManager->attach(new PublicationsSliderDeletedListener());
            //$eventManager->attach(new PublicationsFlashMessengerListener());
    ...
    public function getConfig()
    {
    	...
    	$configFiles = array(
    	    ...
    	    // Templating plugins
    	    include __DIR__ . '/config/plugins/ListPublicationsPlugin.config.php',
