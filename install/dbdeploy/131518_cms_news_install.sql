...
-- -----------------------------------------------------
-- Table `melis_cms_news`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `melis_cms_news` ;

CREATE TABLE IF NOT EXISTS `melis_cms_news` (
...
-- -----------------------------------------------------
-- Table `melis_cms_publication_texts`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `melis_cms_publication_texts` ;

CREATE TABLE IF NOT EXISTS `melis_cms_publication_texts` (
